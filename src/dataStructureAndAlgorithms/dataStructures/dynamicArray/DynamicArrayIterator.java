/**
 * DynamicArrayIterator represents an iterator over the elements of an array.
...
public class DynamicArrayIterator<T> implements Iterator<T> {
	 ...
	 * @param size
     */
    public DynamicArrayIterator(DynamicArray<T> collection, int size) {
        items = collection;
		count = size;
		current = 0;
	}
